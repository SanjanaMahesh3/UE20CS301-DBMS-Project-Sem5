...
$max1="select * from payment order by Receipt_number desc limit 1";
$max2="select * from policy order by Policy_number desc limit 1";
...
$pay="Card";
$poln="General Health";
$sql2="insert into policy (Policy_number,Policy_Name,Customer_id,Sum_assured,Price_to_buy) VALUES ($max_val2+1,'$poln',$max_val+1,32000,18000)";
$sql1="insert into payment (Receipt_number,Amount_payed,Amount_remaining,Fine,Policy_number,Customer_id,Payment_method) VALUES ($max_val1+1,0,18000,0,$max_val2+1,$max_val+1,'$pay')";
mysqli_query($conn,$sql1) or die($sql1."Cannot Insert");
mysqli_query($conn,$sql2) or die($sql2."Cannot Insert");
session_start();
echo "Your customer ID is";
echo $max_val+1;
$_SESSION['cust_id']=$max_val+1;
header("Location: exis_user.php");
}
?>
</body>
</html>
